<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Edit role [ {{ model.name }} ]
...
export default {
  mounted() {
    axios.get('vue-trust/role/' + this.$route.params.id + '/edit')
      .then(response => {
  ...
  methods: {
    ...
    onSubmit: function() {
      ...
      if (this.state.$invalid) {
        ...
        axios.put('vue-trust/role/' + this.$route.params.id + '/update', {
