<template>
  <div class="card">
    <div class="card-header">
      <i class="fa fa-table" aria-hidden="true"></i> Permission
...
export default {
  ...
  methods: {  
    ...
    createRow() {      
      window.location = '#/admin/vue-trust/permission/create';
    },
    viewRow(rowData) {
      window.location = '#/admin/vue-trust/permission/' + rowData.id + '/show';
    },
    editRow(rowData) {
      window.location = '#/admin/vue-trust/permission/' + rowData.id + '/edit';
    },
    deleteRow(rowData) {
